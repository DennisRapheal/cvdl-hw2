...
python train.py --model_name fasterrcnn_v2_hard_transform --model_type fasterrcnn_resnet50_fpn_v2 --from_pretrained ./checkpoints/fasterrcnn_resnet50_fpn_v2.pth --batch_size 32 --num_epochs 15
